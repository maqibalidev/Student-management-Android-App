...
public class Model_for_contacts {
    ...
    public Model_for_contacts(String teacher_name, String teacher_data, int teacher_number, int teacher_pic, int drop_down, int drop_up, String num) {
        this.teacher_name = teacher_name;
        this.teacher_data = teacher_data;
        this.teacher_number = teacher_number;
        this.teacher_pic = teacher_pic;
